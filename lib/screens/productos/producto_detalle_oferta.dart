...
class ProductoDetalleOferta extends StatefulWidget {
  final ProductOferta product;
  final String username;

  ProductoDetalleOferta(this.username, this.product);

  @override
  _ProductoDetalleOfertaState createState() => _ProductoDetalleOfertaState();
}

class _ProductoDetalleOfertaState extends State<ProductoDetalleOferta> {
                  ...
                  children: <Widget>[
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "Bs" + widget.product.precioVentaNuevo,
                            style: TextStyle(
                              fontSize: 21.0,
                              fontWeight: FontWeight.bold,
                              color: Colors.black,
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Unidades por Caja : " +
                                widget.product.cantidadUnidadxcaja,
                            style: TextStyle(
                                fontSize: 15.0,
                                height: 1.5,
                                color: Colors.grey[400]),
                        ...
                        Padding(
                          ...
                          child: Text(
                            "Precio Anterior: Bs " +
                                widget.product.precioVentaUnidad,
                            style: TextStyle(
                              fontSize: 15.0,
                              height: 1.5,
                              color: Theme.of(context).primaryColor,
  ...
  Future<void> agregarCarrito() async {
    ...
    llenarCarrito(
        unidad.toString(),
        caja.toString(),
        widget.product.precioVentaNuevo,
        widget.username,
        widget.product.idInventario.toString(),
